...
setwd("C:/Users/lisa/Documents/-These/MANIP_Quest/Share/Analyses/Network/femPub0.25")


##### 1 DATA 
data_FemPub1_full <- read.csv("C:/Users/lisa/Documents/-These/MANIP_Quest/Share/Analyses/SubScale_bysub_num_imputed_FemPub1.csv")
data_FemPub2_full <- read.csv("C:/Users/lisa/Documents/-These/MANIP_Quest/Share/Analyses/SubScale_bysub_num_imputed_FemPub2.csv")
...
gr3 <- list(c(1:2), c(3),c(4:6),
            c(7:8),c(9:11), 
            c(12:15), c(16:18),c(19:24),c(25),c(26),c(27),c(28),c(29))           
...
pdf("FemPub1_corrplot.pdf", width=18, height=14)
...
pdf("FemPub2_corrplot.pdf", width=18, height=14)
...
png("FemPub1_Subscale_Network.png", width=2000, height=1400)
graph.g1<-qgraph(data_FemPub1.cor, graph="glasso", layout="spring",tuning=0.25,
                 ...
                 groups=gr3, color=c("#377eb8", "#fb9a99", "#4daf4a", "#ffffbf", "#ff7f00", "#ffff33", "#bcf60c", "#c77cff", "#a65628", 
                                    "#66c2a5", "#fc8d62", "#46f0f0", "#e78ac3"),title= "During puberty group network",
...
png("FemPub2_Subscale_Network.png", width=2000,height=1400)
graph.g2<-qgraph(data_FemPub2.cor, graph="glasso", layout="spring",tuning=0.25,
                 labels=shortnames_nodes,
                 vsize=7, cut=0, maximum=.45, sampleSize = nrow(data_FemPub2),
                 border.width=0.1, border.color="#a8a8a8", minimum=.03, 
                 groups=gr3, color=c("#377eb8", "#fb9a99", "#4daf4a", "#ffffbf", "#ff7f00", "#ffff33", "#bcf60c", "#c77cff", "#a65628", 
                                              "#66c2a5", "#fc8d62", "#46f0f0", "#e78ac3"),title= "After puberty  group network",
                                              legend=TRUE,legend.mode='style1',GLratio=2.5,layoutScale=1,legend.cex=0.8,
                 nodeNames=names_full)
dev.off()
...
png("FemPub2_Subscale_Centrality3.png", width=400,height=400)
centralityPlot(graph.g2,include=c("Betweenness","Strength"),orderBy = "Betweenness")
dev.off()

png("FemPub1_Subscale_Centrality3.png", width=400,height=400)
centralityPlot(graph.g1,include=c("Betweenness","Strength"),orderBy = "Betweenness")
dev.off()
...
boot0_FemPub1<-bootnet(data_FemPub1, nBoots=2500, default="EBICglasso", tuning = 0.25, type="nonparametric", statistics='edge')
...
dev.off()
corStability(boot3_FemPub1)#   betweeness = 0.127, strenght = 0.436
...
### edge weight accuracy bootstrap ==> non-parametric (resampling rows from the data)
boot0_FemPub2<-bootnet(data_FemPub2, nBoots=2500, default="EBICglasso", tuning = 0.25,type="nonparametric", statistics='edge')
summary(boot0_FemPub2)
pdf("boot0_FemPub2.pdf", useDingbats=FALSE) 
plot(boot0_FemPub2, labels = FALSE, order = "sample")
dev.off()

png("boot0_FemPub2.png") 
plot(boot0_FemPub2, labels = FALSE, order = "sample")
dev.off()


png("boot0_FemPub1.png") 
plot(boot0_FemPub1, labels = FALSE, order = "sample")
dev.off()
