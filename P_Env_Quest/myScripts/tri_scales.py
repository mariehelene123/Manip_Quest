...
Age1=dataset[dataset['A3_age_m']<=162]
Age2=dataset[dataset['A3_age_m']>162]
Age2=Age2[Age2['A3_age_m']<=204]
Age3=dataset[dataset['A3_age_m']>204]
...
Fem_14moins=Fem[Fem['A3_age_m']<=168]
Fem_14_18= Fem[(Fem['A3_age_m'] > 168) & (Fem['A3_age_m'] < 216)]
Fem_18plus=Fem[Fem['A3_age_m']>=216]

Mal_18moins=Mal[Mal['A3_age_m']<216]
Mal_18plus=Mal[Mal['A3_age_m']>=216]
...
MalPub1.to_csv(wd+'\\Analyses\SubScale_bysub_num_imputed_MalPub1.csv')
MalPub2.to_csv(wd+'\\Analyses\\SubScale_bysub_num_imputed_MalPub2.csv')
