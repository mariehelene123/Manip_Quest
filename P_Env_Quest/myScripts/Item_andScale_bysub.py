...
dataset['N03'] = dataset['N03'].replace({'A6': 'A10', 'A7': 'A11'})
...
item_in_network=['A1_sexe',
            ...
            'C_AP',
            'Dcons01','Dcons02','Dcons03','Dcons04','Dcons05','Dcons06','Dcons07','Dcons08','Dcons09','Dcons10',
            'Dcons11','Dcons12','Dcons13','Dcons14','Dcons15','Dcons16',
            'Dcons17','Dcons18','Dcons19','Dcons20','Dcons21','Dcons22','Dcons23',
            'EIRI01','EIRI02','EIRI03','EIRI04','EIRI05',
            'EIRI06','EIRI07','EIRI08','EIRI09','EIRI10','EIRI11','EIRI12','EIRI13','EIRI14',
            'Greseau01', 'Greseau02','Greseau03',
            'Greseau04', 'Greseau05','Greseau06',
            'Greseau07', 'Greseau08','Greseau09','Greseau10', 'Greseau11',
            'Hest01','Hest02','Hest03','Hest04','Hest05','Hest06',
            'Hest07','Hest08','Hest09','Hest10','Hest11','Hest12',
            'Hest13','Hest14','Hest15','Hest16','Hest17','Hest18','Hest19','Hest20','Hest21','Hest22','Hest23',
            'Iobj01','Iobj02','Iobj03','Iobj04','Iobj05','Iobj06','Iobj07','Iobj08',
            'IIpress01','IIpress02','IIpress03','IIpress04',
            'IIpress05','IIpress06','IIpress07','IIpress08',
            'IIpress09','IIpress10','IIpress11','IIpress12',
            'Jcons01','Jcons02','Jcons03','Jcons04','Jcons05',
            'Kinter01','Kinter02','Kinter03','Kinter04',
            'Kinter05','Kinter06','Kinter07','Kinter08',
            'Kinter09','Kinter10',  'Kinter11','Kinter12',
            'Kinter13','Kinter14','Kinter15',
            'Kinter16','Kinter17','Kinter18',
            'Kinter19','Kinter20','Kinter21',
            'L1tact01','L1tact02','L1tact03','L1tact04','L1tact05','L1tact06','L1tact07',
            'L2tact01','L2tact02','L2tact03','L2tact04','L2tact05','L2tact06','L2tact07','L2tact08',
            'L3mouv01','L3mouv02','L3mouv03','L3mouv04','L3mouv05','L3mouv06','L3mouv07','L3mouv08',
            'L4act01','L4act02','L4act03','L4act05','L4act06','L4act07','L4act08','L4act09','L4act10',
            'M1_douleurs_nb',
            'NLpairs01','NLpairs02','NLpairs03','NLpairs04','NLpairs05','NLpairs06','NLpairs07','NLpairs08','NLpairs09','NLpairs10', 
            'sit_eco']
...
nbjusqua15=len(dataset)

exporterdansR['nbjusqua15']=nbjusqua15

#%% analyse des valeurs manquantes par suj pour supprimer sur seulement colonnes utilisées dans analyse

col_analyse=[ 'id','A02','A022','A01','A03','A04','A08','A05','A06','A07',
            'B01','B02','B03','B04','B05','B07','B08',
            'C01',
            'D01[SQ001]','D01[SQ002]','D01[SQ003]','D01[SQ004]','D01[SQ005]','D01[SQ006]','D01[SQ007]','D01[SQ008]','D01[SQ009]','D01[SQ010]','D01[SQ011]','D01[SQ012]','D01[SQ013]','D01[SQ014]','D01[SQ015]','D01[SQ016]','D01[SQ017]','D01[SQ018]','D01[SQ019]','D01[SQ020]','D01[SQ021]','D01[SQ022]','D01[SQ023]',
            'E01[SQ001]','E01[SQ002]','E01[SQ003]','E01[SQ004]','E01[SQ005]','E01[SQ006]','E01[SQ007]','E01[SQ008]','E01[SQ009]','E01[SQ010]','E01[SQ011]','E01[SQ012]','E01[SQ013]','E01[SQ014]',
            'G01[SQ001]','G01[SQ002]','G01[SQ003]','G01[SQ004]','G01[SQ005]','G01[SQ006]','G01[SQ007]','G01[SQ008]','G01[SQ009]','G01[SQ010]','G01[SQ011]',
            'H01[SQ001]','H01[SQ002]','H01[SQ003]','H01[SQ004]','H01[SQ005]','H01[SQ006]','H01[SQ007]','H01[SQ008]','H01[SQ009]','H01[SQ010]','H01[SQ011]','H01[SQ012]','H01[SQ013]','H01[SQ014]','H01[SQ015]','H01[SQ016]','H01[SQ017]','H01[SQ018]','H01[SQ019]','H01[SQ020]','H01[SQ021]','H01[SQ022]','H01[SQ023]',
            'I01[SQ001]','I01[SQ002]','I01[SQ003]','I01[SQ004]','I01[SQ005]','I01[SQ006]','I01[SQ007]','I01[SQ008]',
            'II01[SQ001]','II01[SQ002]','II01[SQ003]','II01[SQ004]','II01[SQ005]','II01[SQ006]','II01[SQ007]','II01[SQ008]','II01[SQ009]','II01[SQ010]','II01[SQ011]','II01[SQ012]',
            'J01[SQ001]','J01[SQ002]','J01[SQ003]', 'J01[SQ004]', 'J01[SQ005]', #'J01[SQ006]',  'J01[SQ007]',
            'K01[SQ001]','K01[SQ002]','K01[SQ003]','K01[SQ004]','K01[SQ005]','K01[SQ006]','K01[SQ007]','K01[SQ008]','K01[SQ009]','K01[SQ010]','K01[SQ011]','K01[SQ012]','K01[SQ013]','K01[SQ014]','K01[SQ015]','K01[SQ016]','K01[SQ017]','K01[SQ018]','K01[SQ019]','K01[SQ020]','K01[SQ021]',
            'L01[SQ001]','L01[SQ002]','L01[SQ003]','L01[SQ004]','L01[SQ005]','L01[SQ006]','L01[SQ007]',
            'L02[SQ001]','L02[SQ002]','L02[SQ003]','L02[SQ004]','L02[SQ005]','L02[SQ006]','L02[SQ007]','L02[SQ008]',
            'L03[SQ001]','L03[SQ002]','L03[SQ003]','L03[SQ004]','L03[SQ005]','L03[SQ006]','L03[SQ007]','L03[SQ008]',
            'L04[SQ001]','L04[SQ002]','L04[SQ003]','L04[SQ005]','L04[SQ006]','L04[SQ007]','L04[SQ008]','L04[SQ009]','L04[SQ010]', #,'L04[SQ004]'
            'M01','N03','N032','N04','N08']

dataset_poursupssujets=dataset.loc[:,col_analyse]
...
for index, row in dataset_poursupssujets.iterrows():
    ...
    valmanquante=count10+count11
    if valmanquante > 17:
        valmanquantetottrop[subject_number] = valmanquante
print(len(valmanquantetottrop))

asupprimertropdemiss=list(valmanquantetottrop.keys())
dataset = dataset[~dataset.id.isin(asupprimertropdemiss)]


nbtropdemiss=len(asupprimertropdemiss)

exporterdansR['nbtropdemiss']=nbtropdemiss
...
##pour supprimer les sujets qui ont plus de 20missing 
miss_parsuj10_asupp=[]
for key, value in miss_parsuj10.items():
    if value > 20:
        miss_parsuj10_asupp.append(key)
dataset = dataset[~dataset["id"].isin(miss_parsuj10_asupp)]
...
for key, value in miss_parsuj11.items():
    if value > 20:
        miss_parsuj11_asupp.append(key)
dataset = dataset[~dataset["id"].isin(miss_parsuj11_asupp)]
...
#%%suppresion à cause du nb de miss et des commentaire

supprimerpourcom=[297,1143,444,765] 

dataset = dataset[~dataset.id.isin(supprimerpourcom)]

nbsupprimerpourcom=len(supprimerpourcom)

exporterdansR['nbsupprimerpourcom']=nbsupprimerpourcom
...
#######Conscience de soi ###################################"""
    ...
    for j in Dinverse :
        ...
        if dataset.loc[i,'D01[SQ0'+k+']']=='A11':
            Dcons[j]=np.nan 
    ##on supprime le D03 car n'est pas utilisé par la nouvelle traduction de Pelletier et diminue la consistence
    D1_privlist=pd.DataFrame(operator.itemgetter(1,5,7,9,13,15,18,20,22)(Dcons))
...
######################## L Profil sensoriel : L04 niveau d'activité
    ...
    L_thresholdlist1=pd.DataFrame(operator.itemgetter(1,4,5,7,8)(L3mouvB)) ##à partir de notre profil
    L_thresholdlist2=pd.DataFrame(operator.itemgetter(2,5,6,9)(L4actB)) ##à partir de notre profil
    L_thresholdlist3=pd.DataFrame(operator.itemgetter(2,4,5,6,7)(L1tactB)) ##à partir de notre profil
    L_thresholdlist=pd.concat([L_thresholdlist1,L_thresholdlist2,L_thresholdlist3],ignore_index=True)
    L_threshold=L_thresholdlist.mean()
    L_threshold=L_threshold.loc[0]
    
    L_behavlist1=pd.DataFrame(operator.itemgetter(2,3,6)(L3mouvB)) ##à partir de notre profil
    L_behavlist2=pd.DataFrame(operator.itemgetter(1,3,7,8)(L4actB)) ##à partir de notre profil
    L_behavlist3=pd.DataFrame(operator.itemgetter(1,3)(L1tactB)) ##à partir de notre profil
    L_behavlist=pd.concat([L_behavlist1,L_behavlist2,L_behavlist3],ignore_index=True)
    L_behav=L_behavlist.mean()
    L_behav=L_behav.loc[0]
...
#################################### N03
    ...
    if dataset.loc[i,'N03']=='A5':
        sit_eco='1'
    if dataset.loc[i,'N03']=='A10':
        sit_eco=np.nan
    if dataset.loc[i,'N03']=='A11':
        sit_eco=np.nan
...
"""
#%% Pour savoir le nb de données manquantes dans le dataset sur les données brutes brutes

miss_A10 = {}  #ne sait pas ou ne comprends pas la question  ne souhaite pas répondre
miss_A11 = {}  #ne souhaite pas répondre 
miss_emp = {}
...
for col in dataset.columns:
    ...
    percentage = round(len(selected_rows) / len(dataset)*100,1)
...
# Iterate over the keys and values in the miss_A10 dictionary
for key, value in miss_A10.items():
    if value > 0.02:
        greater_than_02_A10.append([str(key)+':  ' + str(round(value*100,1))])


for key, value in miss_A11.items():
    if value > 0.02:
        greater_than_02_A11.append([str(key)+':  ' + str(round(value*100,1))])

for key, value in miss_emp.items():
    if value > 0.02:
        greater_than_02_emp.append([str(key)+':  ' + str(round(value*100,1))])

#%% Pour savoir le nb de données manquantes dans les items du network 

Item_bysub_network=Item_bysub_all.loc[:,item_in_network]
...
# Pour chaque colonne du DataFrame
for col in Item_bysub_network.columns:
    # Sélectionner les lignes qui contiennent ' ', 'A11' ou 'A10'
    selected_rows = Item_bysub_network[Item_bysub_network[col].isna()]
    # Calculer le pourcentage de lignes sélectionnées par rapport au nombre total de lignes
    percentage = round(len(selected_rows) / len(dataset)*100,1)
    # Ajouter le pourcentage à la liste des résultats
    ...
    if percentage > 2:
        # Ajouter l'entrée au nouveau dictionnaire
        miss_item_bcp[col] = percentage
    

pourcentage_nan_items = round((Item_bysub_network.isnull().sum().sum()/ Item_bysub_network.size) * 100,2)

exporterdansR['pourcentage_nan_items']=pourcentage_nan_items


#%% Pour savoir le nb de données manquantes dans les subscales du network 


Measures_bysub=Scale_bysub_all.loc[:,measure_in_networks]

Measures_bysub.to_csv(wd+'\\Analyses\\Measures_bysub.csv',index=False)

#visualiser les données manquantes
null_values = Measures_bysub.isnull()
msno.matrix(Measures_bysub)

miss_subscale = {}
miss_subscale_bcp = {}

for col in Measures_bysub.columns:
    selected_rows = Measures_bysub[Measures_bysub[col].isna()]
    percentage = round(len(selected_rows) / len(dataset)*100,1)
    miss_subscale[col] = percentage
    if percentage >1:
        miss_subscale_bcp[col] = percentage

miss_subscale_bcpcsv=pd.DataFrame(miss_subscale_bcp,index=list(range(1)))
miss_subscale_bcpcsv.to_csv(wd+'\\Analyses\\miss_subscale_bcp.csv',index=False)

pourcentage_nan_measures = round((Measures_bysub.isnull().sum().sum()/ Measures_bysub.size) * 100,2)

exporterdansR['pourcentage_nan_measures']=pourcentage_nan_measures
 
#%% Pour savoir le nb de données manquantes par suj dans les subscales du network 

pourtestmissparsuj=Scale_bysub_all.loc[:,['numquest']+ measure_in_networks]

miss_final_parsuj_bcp = {}
miss_final_parsuj = {}
for index, row in pourtestmissparsuj.iterrows():
    numsuj = row['numquest']
    nbmiss = row.isnull().sum()
    miss_final_parsuj[numsuj] = nbmiss
    if nbmiss > 2:
        miss_final_parsuj_bcp[numsuj] = nbmiss
...
nan_count = pourtestmissparsuj.isna().sum().sum()
...
#%%données à exporter pour mettre direct dans l'article dans R

# Convertir le dictionnaire en DataFrame


exporterdansRcsv = pd.DataFrame(exporterdansR,index=list(range(1)))

exporterdansRcsv.to_csv(wd+'\\Analyses\\exporterdansR.csv',index=False)
...
Measures_bysub_imputed=MICE().fit_transform(Measures_bysub)
Measures_bysub_imputed=pd.DataFrame(Measures_bysub_imputed)

##renommer les colonnes de Measures_bysub_imputed
num_col=list(Measures_bysub.columns)
imputed_col=list(Measures_bysub_imputed.columns)
mapping=dict(zip(imputed_col, num_col))
Measures_bysub_imputed = Measures_bysub_imputed.rename(columns=mapping)
Measures_bysub_imputed.to_csv(wd+'\\Analyses\\Measures_bysub_imputed.csv')
...
Item_bysub_imputed=MICE().fit_transform(Item_bysub_network)
Item_bysub_imputed=pd.DataFrame(Item_bysub_imputed)

##renommer les colonnes de Item_bysub_imputed
num_col=list(Item_bysub_network.columns)
...
cols_Scale = set(Measures_bysub_imputed)
...
ItemandScale_imp_bySub=pd.concat([Measures_bysub_imputed,Item_bysub_copie], axis=1)
