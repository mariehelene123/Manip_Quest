...
data_pub3 <- read.csv("C:/Users/lisa/Documents/-These/MANIP_Quest/Share/Analyses/Scale_Pub3_fornetwork2.csv")
...
data_pub3.cor<-cor_auto(data_pub3) #data including covariates
ggcorrplot(data_pub3.cor)

data_pub1.glasso<-glasso(data_pub1.cor,0.25)
data_pub2.glasso<-glasso(data_pub2.cor,0.25)
data_pub3.glasso<-glasso(data_pub3.cor,0.25)
...
gr3 <- list(c(1:2), c(3),c(4:6),
            c(7:8),c(9:12), 
            c(13:16), c(17:19),c(20:26),c(27),c(28))           
...
pdf("Figure1_Pub1_Ar.pdf")
graph.g1<-qgraph(data_pub1.cor, graph="glasso", layout="spring", 
...
pdf("Figure1_Pub2_Ar.pdf")
graph.g2<-qgraph(data_pub2.cor, graph="glasso", layout="spring", 
                vsize=7, cut=0, maximum=.45, sampleSize = nrow(data),
                border.width=1.5, border.color="black", minimum=.03, 
                groups=gr3, color=c('#a8e6cf', '#dcedc1', '#ffd3b6', '#ff8b94',
                                             '#00ffff','#3300ff','#660066','#6666ff',
...
pdf("Figure1_Pub3_Ar.pdf")
graph.g3<-qgraph(data_pub3.cor, graph="glasso", layout="spring", 
                vsize=7, cut=0, maximum=.45, sampleSize = nrow(data),
                border.width=1.5, border.color="black", minimum=.03, 
                groups=gr3, color=c('#a8e6cf', '#dcedc1', '#ffd3b6', '#ff8b94',
                                             '#00ffff','#3300ff','#660066','#6666ff',
