...
##### 1 DATA 
data_full <- read.csv("C:/Users/lisa/Documents/-These/MANIP_Quest/Share/Analyses/SubScale_bysub_num_imputed.csv")
data_raw <- read.csv("C:/Users/lisa/Documents/-These/MANIP_Quest/Share/Analyses/Scale_bysub_num.csv") 
