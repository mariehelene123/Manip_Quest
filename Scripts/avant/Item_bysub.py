...
################################### 
    ...
    item_suj=[numquest,A1_sexe,A2_genre,A3_age_m,A3_age_y,A4_taille,A5_poids,A6_IMC]
...
Item_bysub=Final_item
Item_bysub.to_csv(wd+'\\Analyses\\Item_bysub.csv')
#%%
miss_final = {}
