...
#load dataset
dataset=pd.read_csv('.\\Analyses\\Scale_bysub.csv')
dataset_item=pd.read_csv('.\\Analyses\\Item_bysub_num.csv')
...
for i in dataset.index:
    if dataset.loc[i,'A1_sexe'] != dataset.loc[i, 'A2_genre']:
        z=z+1


mask = dataset['A1_sexe'].ne(dataset['A2_genre'])
...
col_disc=['A3_age_m','A3_age_y','C_AP','B2_regles','M1_douleurs_nb','classe',
'filiere',
'sit_eco',
'langue']
